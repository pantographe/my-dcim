...
RSpec.describe EmptyDataComponent, type: :component do
  let(:component) { described_class.new }
  let(:rendered_component) { render_inline(component) }

  context "with default icon and text" do
    it "renders the component" do # rubocop:disable RSpec/ExampleLength
      expect(rendered_component.to_html).to have_tag("div", with: { class: "text-center text-secondary-emphasis" }) do
        with_tag("div", with: { class: "text-center text-secondary-emphasis" }) do
